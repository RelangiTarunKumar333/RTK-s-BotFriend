...
class ChatApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Chat with our BotFriend")
        ...
        self.heading_label = tk.Label(self.heading_frame, text="Chat with our BotFriend", font=("Helvetica", 24, "bold"), fg='#ecf0f1', bg='#34495e')
